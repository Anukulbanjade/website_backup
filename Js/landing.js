let welcomeText = 'You can continue by signing in with username guest.';
let sss = welcomeText.replace('\n', '<br><br>');
document.getElementById('welcomeText1').innerHTML = sss;
let delay = 50; //delay in ms
setInterval(() => {
    const qw = document.getElementById('welcomeText1').offsetHeight + 30; // Adjust the value here to reduce the space
...
let listOfFiles = {
	...
	'About_Me.txt': () => {
		historyCommands += "Hi I'm Anukul Banjade<br><br>";
	},
	'Contact_Me.txt': () => {
		historyCommands +=
			'You can get in touch with me anukulbanjade@gmail.com<br><br>';
	},
	'Github.txt': () => {
		historyCommands +=
			"<a href = 'https://github.com/Anukulbanjade/' target='_blank'>https://github.com/Anukulbanjade/</a><br><br>";
	},
	'Linkedin.txt': () => {
		historyCommands +=
			"<a href = 'https://www.linkedin.com/in/anukulbanjade/' target='_blank'>https://www.linkedin.com/in/anukulbanjade/ </a><br><br>";
	},
	'Credits.txt': () => {
		historyCommands +=
